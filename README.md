...
- **다국어 UI (i18n)**: 한국어, English, Espa&ntilde;ol, 日本語 4개 언어 UI 전환
- **스마트 학습 알고리즘**: 1/3 복습 + 2/3 새 단어 구성, 퀴즈 오답 단어 우선 복습
- **학습 연속일수(Streak)**: 연속 학습 일수 추적 및 메인 화면 배너 표시
- **추천 카드 하이라이팅**: 가중치 점수 기반 학습 활동 추천 (점멸 애니메이션)
...
| **학습 스트릭** | 연속 학습 일수 추적, 최고 기록 표시, 오늘 학습 여부 뱃지 |
| **추천 학습 카드** | 가중치 점수 알고리즘 기반 맞춤 학습 카드 추천 및 점멸 하이라이팅 |
...
| **React Router** | 라우팅 |
| **Axios** | HTTP 클라이언트 |
| **react-i18next** | 다국어 UI (ko/en/es/ja) |
