  ...
  return (
    <div className="flex items-center gap-4 py-3 border-b border-slate-100 last:border-0">
      ...
      <div className="text-right">
        <p className="text-sm font-semibold text-indigo-600">{user.accuracy.toFixed(1)}%</p>
        <p className="text-xs text-slate-400">{user.total_quizzes} 퀴즈</p>
      </div>
    </div>
  )
}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-semibold text-indigo-600">{ganaStats.accuracy.toFixed(1)}%</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-100">
                      <div className="flex justify-between text-sm">
                        <span className="text-slate-500">정답률</span>
                        <span className="font-semibold text-purple-600">{wordStats.accuracy.toFixed(1)}%</span>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <tbody>
                          {overview.activity_breakdown.map((activity, index) => (
                            <tr key={index} className="border-b border-slate-50 hover:bg-slate-50">
                              ...
                              <td className="py-2 px-3 text-right font-medium text-slate-800">{activity.accuracy.toFixed(1)}%</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
